...
const isMobileMedia = window.matchMedia("(max-width: 768px), (pointer: coarse)");
const baseFov = 25;
const mobileFov = 40; // Reduced FOV for mobile
const sizes = { width: window.innerWidth, height: window.innerHeight };
const baseTarget = new THREE.Vector3(-0.5606242876205354, 2.398642331480653, -0.6845418531121432);
const basePosition = new THREE.Vector3(13.416304985610472, 7.498278735059506, 14.793638164008605);
...
window.addEventListener("orientationchange", () => setTimeout(updateExperienceSize, 150));
...
const textureMap = {
    ...
    fourth: "/textures/TextureSet4.webp",
};
