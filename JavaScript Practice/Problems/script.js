...
const progress =  document.querySelector("#scrolled");
...
window.addEventListener("scroll", function(){
    ...
    console.log(scrollTop ,"top " , scrollHeight, "height" ,  clientHeight,"client")
    let width = scrollTop/(scrollHeight-clientHeight) *100;
